...
class HedgingEnv:
    ...
    def simulate_batch(self, actor, batch_size, alpha=0.05,
        ...
        no_rate_PnL       = PnL_storage.transpose(0, 1)
        ...
        return (
            ...
            next_states, dones,
            portfolio_values, derivative_values, no_rate_PnL, terminal_pnl,
    ...
    def rollout_from_paths(self, actor, S_paths, h_paths, R_paths, deriv_prices,
        ...
        no_rate_PnL       = pnl_s.transpose(0, 1)
        ...
        return (states, actions, log_probs, costs,
                next_states, dones,
                portval_s, deriv_prices, no_rate_PnL, terminal_pnl,
                S_paths, h_paths, R_paths)
